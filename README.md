...
[![Tests](https://img.shields.io/badge/Tests-854_pass-22C55E?style=flat-square)]()
...
├───────────────────────────────────────────────────────────────┤
│  crates/    Rust WASM バトルエンジン (806 行, 148KB .wasm)    │
└───────────────────────────────────────────────────────────────┘
```
...
| **lib/** | ~3K | 後方互換ユーティリティ |
| **crates/** | 1,004 | Rust → WASM バトルエンジン |
...
| Test suite | 854 tests, 29 files, all passing |
| Coverage | 91.72% (V8 provider) |
| PBT properties | 56 (fast-check) |
...
| **Rust** | 1,004 lines |
| **Test suite** | 854 tests, 29 files |
| **Coverage** | 91.72% |
| **PBT properties** | 56 |
| **Benchmarks** | 27 (TS) + 16 (Rust) |
