...
export const WIKI_GEOGRAPHY = [{
    ...
    subCategory: "宇宙・天文",
    description:
      "M104銀河（ソンブレロ銀河）のハロー領域に位置する連星系で、シンフォニー・オブ・スターズをはじめとする居住可能惑星を擁するE16文明圏の母星系である。主星Ea16はスペクトル型K2Vの橙色主系列星で、伴星Eb16はスペクトル型M3の赤色矮星であり、両星の軌道共鳴によって安定したハビタブルゾーンが形成されている。連星系全体の年齢は約62億年と推定され、豊富な重元素を含むため惑星形成が活発だった。E16連星系は東暦以前から航行可能な距離にあり、初期入植船団が到達して以来、銀河ハローにおける最重要の交通・交易拠点として発展を遂げてきた。",
    descriptionEn:
      "Located in the halo region of the M104 Galaxy (Sombrero Galaxy), this binary star system is the mother system of the E16 civilization zone, which harbors habitable planets including Symphony of Stars. The primary star Ea16 is an orange main-sequence star of spectral type K2V, while its companion Eb16 is a red dwarf of spectral type M3. The orbital resonance between the two stars creates a stable habitable zone. The estimated age of the binary system is approximately 6.2 billion years, and it contains abundant heavy elements, leading to active planet formation. The E16 binary system has been within navigable distance since before the Eastern Calendar, and since the arrival of the initial colonization fleet, it has developed into the most important transportation and trade hub in the galactic halo.",
  },{
    id: "Ea16" as WikiId,
    name: "イーエー16",
    nameEn: "Ea16",
    ...
    subCategory: "宇宙・天文",
    description:
      "E16連星系の伴星で、スペクトル型M3の赤色矮星。質量は0.4太陽質量、表面温度は約3,400Kであり、主星Ea16から平均約12AUの距離を公転している（離心率0.2前後の長楕円軌道）。Eb16自体のハビタブルゾーンは極めて狭いが、潮汐加熱を受ける可能性のある衛星系が存在すると推測されている。赤色矮星特有の長寿命（推定数千億年）により、主星が赤色巨星へ進化した後も連星系全体の重力バランスを維持する役割を果たすと予測されている。スライム危機期にはEb16の放射変動がリーチ・ドレインの遺伝子変異を誘発した可能性が指摘されている。",
    descriptionEn:
