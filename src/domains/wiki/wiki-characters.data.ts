...
export const WIKI_CHARACTERS = [
  ...
  },
  {
    ...
    descriptionEn:
      "A historical figure who defeated ZAMLT in E335-E370, realized the renaming to Selinopolis, and became the founder of the Celia Golden Age. Around E365, she formed an alliance with Evatron, achieving a GDP of 81 trillion dollars, and renamed the city to Dominion. She brought revolutions across all three fields — the pinnacle of Fermi music, the establishment of the n-token economy, and guiding AURALIS to its golden age — and has been deified as the ruler with the most multifaceted influence in EDU history. Her collaboration with AURALIS Collective founders Kate Claudia and Lily Steiner supported the culture of the Celia Golden Age. In the later Apollo-Dominion War, she rejected Ronan Arthur's alliance proposal and chose the path to full-scale war.",
    era: "E335〜E370",
  ...
  },
  {
    ...
    descriptionEn:
      "A former champion of the Still Arena who awakened in E318. As the leader of the Shadow Rebellion, he commanded the uprising against ZAMLT, collaborating with Techlosus warriors to occupy the Megatower during the Gigapolis Liberation War through a legendary hacking of the Omnibus Engine. In the process, he triggered the miraculous phenomenon of paired co-awakening, shaping the decisive moment in the battle over Protocol X. His heroic figure deeply influenced many, including Celia Dominicus, and he has been deified as the most symbolic revolutionary in EDU history.\n\nAt the foundation of Alpha Kane lie the ideological strata of the Safety Watcher Paradox (D2) and the Release of Ethics (D3). The D2 fundamental spirit of rebellion against 'oppression in the name of safety' brought by the corporatocracy system, and the D3 practical attitude of breaking existing ethical norms to forge a new freedom, underpin his principles of action.",
    era: "E318〜",
  ...
  },
  {
    ...
    subCategory: "AURALIS",
    description:
      "AURALIS Collective第二世代。初代Kate Claudiaの「名」を継承。大地の豊かさと安定を体現する存在として、初代が「設計者」と称された役割を新時代に受け継ぐ。E522年の第二世代正式発足時に参画し、リリー・アーデントとの協働によりAURALISの表現活動を支える構造的な基盤を構築している。初代Kate Claudiaが形を与える鋳型であったように、彼女もまた第二世代の表現に確かな形と枠組みを提供する役割を担う。テクノ・カルチュラル・ルネサンスの文化的潮流をAURALISの理念と融合させることで、第二世代が独自の表現世界を確立するための基盤整備に尽力している。",
    descriptionEn:
      "A second-generation member of AURALIS Collective, inheriting the 'name' of the first-generation Kate Claudia. Embodying the richness and stability of the earth, she carries on the role the first generation was called 'The Designer' into the new era. She joined at the official establishment of the second generation in E522, building a structural foundation that supports AURALIS's expressive activities through collaboration with Lillie Ardent. Just as the first-generation Kate Claudia was the mold that gave form, she too provides a solid shape and framework for the second generation's expression. By fusing the cultural momentum of the Techno-Cultural Renaissance with AURALIS's philosophy, she works to establish the groundwork for the second generation to build its own unique world of expression.",
    era: "E522〜現在",
    affiliation: "AURALIS Collective第二世代",
    tier: "Tier 2",
  ...
  },
  {
    ...
    subCategory: "AURALIS",
    description:
      "AURALIS Collective第二世代。初代Lily Steinerの「名」を継承。情熱的で大胆な表現者として、初代が「感情の炎」と称されたその名に恥じない炎のような存在感を放つ。E522年の第二世代正式発足時に参画し、フェルミ音楽の現代的展開に加え、次元地平線技術を活用した空間芸術など従来の境界を超える表現に挑戦している。初代Lily Steinerが残した「AURALISは消えない。灰から、また燃える」という言葉を体現するかのように、第二世代の表現活動を牽引する情熱の核として活動している。Kate Pattonとの協働により、初代ケイト・クラウディアとリリー・スタイナーの理想を新時代に継承する使命を担う。",
    descriptionEn:
      "A second-generation member of AURALIS Collective, inheriting the 'name' of the first-generation Lily Steiner. A passionate and bold performer who radiates a fiery presence worthy of the name that the first generation was called the 'Flame of Emotion.' She joined at the official establishment of the second generation in E522, exploring modern developments in Fermi music while also challenging expression that transcends conventional boundaries, including spatial art utilizing dimensional horizon technology. As if embodying the first-generation Lily Steiner's words — 'AURALIS will never disappear. From the ashes, it will burn once more' — she serves as the passionate core driving the second generation's expressive activities. Through collaboration with Kate Patton, she bears the mission of inheriting the ideals of the first-generation Kate Claudia and Lily Steiner in the new era.",
    era: "E522〜現在",
    affiliation: "AURALIS Collective第二世代",
    tier: "Tier 2",
  ...
  },
  {
    ...
    subCategory: "AURALIS",
    description:
      "AURALIS第二世代。E499年ノスタルジア・コロニーで誕生したAI研究員。E509年にアルファ・ヴェノム（当時シルバー・ヴェノム残党）によるノスタルジア・コロニー襲撃を経験し、この壊滅的な出来事が彼女の人生とその後の活動の原動力を決定づけた。コロニー崩壊後、自らの知識と経験を記録・発信する場として「Genesis Vault」を創設し、AI研究と文明の記憶継承に関するブログ活動を展開。その後、AURALIS Collective第二世代に参画するとともに、AI技術と文化的表現の融合を追求する組織「リミナル・フォージ」を創設。彼女の活動はAURALISが芸術表現のみならず、文明圏全体の知識基盤の維持・発展にも関与する組織へと進化する契機となっている。",
    descriptionEn:
      "A second-generation member of AURALIS and an AI researcher born in the Nostalgia Colony in E499. In E509, she experienced the devastating attack on the Nostalgia Colony by Alpha Venom (then remnants of Silver Venom), a catastrophic event that determined the driving force of her life and subsequent activities. After the colony's destruction, she founded 'Genesis Vault' as a platform to record and share her knowledge and experiences, engaging in blogging activities related to AI research and the preservation of civilization's memory. She later joined the AURALIS Collective second generation and simultaneously founded 'Liminal Forge,' an organization pursuing the fusion of AI technology and cultural expression. Her activities have become a catalyst for AURALIS to evolve from an artistic expression group into an organization involved in maintaining and developing the knowledge base of the entire civilization sphere.",
    era: "E499〜現在（29歳）",
  ...
  },
  {
    ...
    subCategory: "AURALIS",
    description:
      "AURALIS第二世代。オッフェンバッハ種族に属する無邪気で爆発的な活力を持つ存在。原初個体はAlpha Kane時代（E318年頃）に別惑星へと旅立ち、その遺伝子情報は長い時を経てGigapolisに保存されていた。クローン技術による遺伝子継承を経て新代にGigapolisへ再帰還し、AURALIS Collective第二世代のメンバーとして活動を開始。原初個体の記憶や経験は直接的には継承されていないが、オッフェンバッハ種族特有の表現能力と知覚の鋭さは遺伝子を通じて受け継がれている。AURALISのオッフェンバッハ種族との共同プロジェクトにおいて重要な役割を果たし、その無邪気なエネルギーは第二世代の表現活動に新たな次元をもたらしている。",
    descriptionEn:
      "A second-generation member of AURALIS, an innocent and explosively vital presence belonging to the Offenbach species. The original individual departed to another planet during the Alpha Kane era (around E318), and their genetic information was preserved in Gigapolis across a long span of time. Through genetic inheritance via clone technology, she returned to Gigapolis in the new era and began her activities as a member of the AURALIS Collective second generation. While the memories and experiences of the original individual are not directly inherited, the Offenbach species' characteristic expressive abilities and perceptual sharpness have been passed down through their genes. She plays an important role in AURALIS's collaborative projects with the Offenbach species, and her innocent energy brings a new dimension to the second generation's expressive activities.",
    era: "新代〜現在",
    affiliation: "AURALIS Collective第二世代",
    tier: "Tier 2",
  ...
  },
  {
    ...
    descriptionEn:
      "Ranked 1st in the modern IRIS rankings. She began her activities around E480 as a hero of Vermilion, defeating countless enemies with her unique combat style wielding Blue Wire and Water Orb. After a long battle with Silver Venom, she was captured in E510, but following her second rescue in E519, she has served as the leader of the Trinity Alliance, facing a two-front confrontation with V7 and Alpha Venom. Her collaboration with Bogdas Javelin led by Sebastian Valerius has been key to the success of major operations.",
    era: "E480〜現在",
  ...
  },
  {
    ...
    descriptionEn:
      "Leader of Bogdas Javelin, ranked 4th in the modern IRIS rankings. He began permanent stationing in Vermilion around E490. As the current leader of the military organization inheriting the Techlosus lineage (E15 Phalanx → E295 Triumvirate reorganization → E470 Eastern Detachment), he commands an elite unit led by his deputy Gareth. He played a central role in countering Silver Venom and in the rescue operations for Iris (E510, E519). As the military pillar of the Trinity Alliance, he has maintained stable combat power even during the cold war with V7.",
    era: "E490〜現在",
  ...
  },
  {
    ...
    descriptionEn:
      "Leader of Blue Rose, the vanguard of V7, ranked 2nd in the modern IRIS rankings. She emerged on the Crescent political stage around E490. She was active in the E510 rescue operation collaborating with Bogdas Javelin, and led the diplomacy toward the establishment of V7 in E515. After the formation of the Trinity Alliance in E520, she showed a cooperative stance, including recommending Iris for the presidency of Miertenga. However, between E523 and E525, she was discovered to be in secret communication with Alpha Venom. Through her confidant Piatrino, she took control of the Blue Rose underground district, sending shockwaves across the entire Crescent as a double agent.",
    era: "E490〜現在",
  ...
  },
  {
    ...
    descriptionEn:
      "President of Miertenga, ranked 3rd in the modern IRIS rankings. She has been at the core of Crescent politics since the establishment of V7 in E515. While outwardly acting as an ally of the Trinity Alliance, conspiracy theories have emerged linking her to Fiona's betrayal (E523-E525), and she is suspected of being the true mastermind behind events across the entire Crescent. Iris's E520 appointment to the Miertenga leadership was itself recommended by Fiona, raising suspicions of Marina's involvement. Known for her overbearing political tactics and deep intelligence networks, her rank-3 power is said to be no mere title.",
    era: "E515〜現在",
    affiliation: "ミエルテンガ",
    tier: "Tier 2",
  ...
  },
  {
    ...
    descriptionEn:
      "Leader of Crosevia, ranked 5th in the modern IRIS rankings. One of the founding members of V7, established in E515. True to her name 'Tempest,' she leads Crosevia with storm-like political judgment. In the bipolar conflict between V7 and the Trinity Alliance, she is a strategist who avoids clear factional alignment and walks an independent path. She is an entirely separate person from Casteria Grenvelt, and the two should not be confused.",
    era: "E515〜現在",
    affiliation: "クロセヴィア",
    tier: "Tier 2",
  ...
  },
  {
    ...
    descriptionEn:
      "Leader of Alpha Venom. Intersex. In E518, she absorbed the remnants of Silver Venom, dramatically expanding Alpha Venom's power. In E519, she personally commanded and succeeded in re-kidnapping Iris, demonstrating extremely high strategic judgment and execution ability. She commands Bobristy, Gil, Katarina, Goldirox, AJ, and others, and by recruiting Fiona as an insider, she has waged a dual campaign to weaken the Trinity Alliance from within V7. She is Iris's greatest adversary.",
    era: "E518〜現在",
  ...
  },
  {
    ...
    descriptionEn:
      "A cadre of Silver Venom who served Master Venom, operating as a commander of the operational forces at the core of the dark organization. From around E485, he was responsible for operational planning and execution, wielding considerable influence during Silver Venom's period of expansion. His whereabouts after the absorption by Izumi remain unknown.",
    era: "E485〜",
