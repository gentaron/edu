...
export const WIKI_ORGANIZATIONS = [{
    ...
    descriptionEn:
      "The integrated entity of five mega-corporations active from E301 to E318, a meta-corporate body that came to dominate the economy of the E16 star system. The name ZAMLT is derived from the initial letters of its five constituent corporations' English names — Z (Zebra Corporation), A (Aloeol Corporation), M (Mamon Corporation), L (Llorenz Corporation), T (Tron Corporation). Founder Elliot Strauss emerged victorious from the corporatocracy hegemony struggle among over 200,000 contenders in Gigapolis, consolidating economic power into these five corporations to establish ZAMLT. By interconnecting each corporation's Omni-Engine, it constructed a groundbreaking economic system capable of controlling all financial transactions across the entire E16 star system in real time. However, the extreme pursuit of economic efficiency led to social polarization, resulting in the fixation of class disparities within the A-Registry system. ZAMLT replaced the free economic order that the corporatocracy system (Corporatum Publica) had built with a centralized control structure dominated by an extremely small number of mega-corporations. This transformation became the direct target of a long arc of resistance, from El Folhaus's Maastricht Revolution (E150) to Alpha Kane's Gigapolis Liberation War (E318). Low-class citizens under ZAMLT's rule suffered severe poverty and restrictions on their rights, leading to the formation of underground resistance organizations such as the Shadow Rebellion. Following the destruction of Tron Corporation in E318, ZAMLT shifted to a four-corporation system before ultimately collapsing completely in Alpha Kane's Gigapolis Liberation War. ZAMLT's economic legacy continued to influence the n-token system and UECO's economic framework for a long time afterward. After the collapse, some remnants of the organization are said to have become the nucleus of Silver Venom, making it a key to understanding the historical lineage of underground organizations. Leaders included first-generation Elliot Strauss (E301-E318, founder and supreme leader), with the CEOs of the five mega-corporations (Rafael Drake/Tron, Carlos Vandam/Mamon, Arthur Grim/Zebra, Elizabeth Lindberg/Llorenz, Iris Nova/Aloeol) forming its executive cadre.\n\nAt the foundation of ZAMLT lie the ideological strata of Hyper-Futurism First (D1) and the Safety Watcher Paradox (D2). The D1 logic, which rationalizes present sacrifices from the ultra-long-term perspective of 'civilization's perpetuation,' and the D2 paradox of becoming the ultimate apparatus of repression while advocating 'safety and order,' ideologically sustained ZAMLT's hegemonic structure. The Shadow Rebellion's resistance holds historical significance as a fundamental antithesis to this dual ideological oppression.",
