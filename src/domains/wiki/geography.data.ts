...
export const WIKI_GEOGRAPHY = [
  /* 宇宙・天文 */
  {
    ...
    descriptionEn: "Located in the halo region of the M104 Galaxy (Sombrero Galaxy), this binary star system is the mother system of the E16 civilization zone, which harbors habitable planets including Symphony of Stars. The primary star Ea16 is an orange main-sequence star of spectral type K2V, while its companion Eb16 is a red dwarf of spectral type M3. The orbital resonance between the two stars creates a stable habitable zone. The estimated age of the binary system is approximately 6.2 billion years, and it contains abundant heavy elements, leading to active planet formation. The E16 binary system has been within navigable distance since before the Eastern Calendar, and since the arrival of the initial colonization fleet, it has developed into the most important transportation and trade hub in the galactic halo.",
  },

  {
    ...
    descriptionEn: "The primary star of the E16 binary system, an orange main-sequence star of spectral type K2V. It has a mass of approximately 0.80 solar masses, a surface temperature of approximately 4,900K, and a luminosity of about 0.4 times that of the Sun. It provides stable light and heat to the inner planets, including Symphony of Stars, with its habitable zone offering optimal conditions for Earth-type planets. The average orbital distance from its companion Eb16 is about 12 AU (long elliptical orbit with eccentricity ~0.2), and the gravitational interaction between the two stars stabilizes the orbits of small bodies within the system. A metal-poor old star (halo population), Eastern Calendar-era astronomers considered the stability of Ea16 as the decisive basis for system colonization.",
  },
