    ...
    <div className="relative min-h-screen bg-cosmic-dark">
      ...
      <div className="relative z-10">
        <PageHeader
          ...
          title={<Link href="/wiki#AURALIS" className="text-cosmic-gradient hover:underline">AURALIS Collective</Link>}
              ...
              <div className="glass-card glass-card-hover rounded-xl overflow-hidden transition-all duration-300">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="space-y-2 text-sm text-cosmic-muted">
                    <p><span className="text-cosmic-text">E270頃:</span> AURALIS Proto（<Link href="/wiki#Diana" className="text-cosmic-muted hover:text-nebula-purple hover:underline">Diana</Link>時代の前身組織）</p>
                    <p><span className="text-cosmic-text">E290:</span> 正式組織化</p>
                    <p><span className="text-cosmic-text">創設者:</span> <Link href="/wiki#Kate Claudia" className="text-cosmic-muted hover:text-nebula-purple hover:underline">Kate Claudia</Link>, <Link href="/wiki#Lily Steiner" className="text-cosmic-muted hover:text-nebula-purple hover:underline">Lily Steiner</Link></p>
                    <p><span className="text-cosmic-text">参加:</span> <Link href="/wiki#レイラ・ヴィレル・ノヴァ" className="text-cosmic-muted hover:text-nebula-purple hover:underline">Layla Virell Nova</Link> (E325以降)</p>
                  </div>
                  <div className="bg-gold-accent/10 border border-gold-accent/30 rounded-lg p-3 text-xs text-gold-accent">
                    ...
                    <p className="text-cosmic-muted leading-relaxed">初代は5名ではなかった。Kate Claudia・Lily Steinerを中心とする集団で、Laylaを含む複数の参加者がいたが、正確な人数は不明。第二世代の5人体制とは異なる。</p>
                  </div>
                  <div className="text-sm text-cosmic-muted">
                    <p><span className="text-cosmic-text">E335〜E370:</span> <Link href="/wiki#セリア・ドミニクス" className="text-cosmic-muted hover:text-nebula-purple hover:underline">セリア黄金期</Link>に最盛期</p>
                    <p><span className="text-cosmic-text">E400:</span> エヴァトロン弾圧で解体。Kate Claudia・Lily Steinerは逮捕・消息不明</p>
                    <p><span className="text-cosmic-text">Layla:</span> 冷凍保存（サイバネティクスによる長命ではない）</p>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-card glass-card-hover rounded-xl overflow-hidden transition-all duration-300 animate-pulse-glow">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    {[
                      { name: "Kate Patton", desc: "大地の豊かさ・安定", color: "bg-green-500/20 border-green-500/40", img: "https://raw.githubusercontent.com/gentaron/image/main/KatePatton.png", wiki: "/wiki#Kate Patton" },
                      { name: "Lillie Ardent", desc: "情熱的で大胆", color: "bg-red-500/20 border-red-500/40", img: "https://raw.githubusercontent.com/gentaron/image/main/LillieArdent.png", wiki: "/wiki#Lillie Ardent" },
                      { name: "Layla Virell Nova", desc: "Pink Voltage — 冷凍保存から復活、ミナたちと同年代", color: "bg-pink-500/20 border-pink-500/40", img: "https://raw.githubusercontent.com/gentaron/image/main/LaylaVirellNova.png", wiki: "/wiki#レイラ・ヴィレル・ノヴァ" },
                      { name: "Mina Eureka Ernst", desc: "celestial × avant-garde, AI研究員", color: "bg-blue-500/20 border-electric-blue/40", img: "https://raw.githubusercontent.com/gentaron/image/main/MinaEurekaErnst.png", wiki: "/wiki#ミナ・エウレカ・エルンスト" },
                      { name: "Ninny Offenbach", desc: "無邪気で爆発的な活力 — 原初個体はAlpha Kane時代に別惑星へ、クローン技術で遺伝子継承ののちGigapolisに再帰還", color: "bg-yellow-500/20 border-gold-accent/40", img: "https://raw.githubusercontent.com/gentaron/image/main/NinnyOffenbach.png", wiki: "/wiki#Ninny Offenbach" },
                    ].map((m) => (
                      <div
                        key={m.name}
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          <p className="text-sm font-medium text-cosmic-text truncate">
                            <Link href={m.wiki} className="hover:text-electric-blue hover:underline">{m.name}</Link>
                          </p>
                  ...
                  <div className="mt-4 bg-cosmic-dark/50 border border-gold-accent/20 rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-xs text-cosmic-muted leading-relaxed">
                      <p>ニニーの<span className="text-cosmic-text font-medium">原初個体</span>は<Link href="/wiki#アルファ・ケイン" className="text-cosmic-muted hover:text-nebula-purple hover:underline">Alpha Kane</Link>時代のGigapolisに存在していたが、Kaneと袂を分かち別惑星へ離脱した。</p>
                      <p>そこから<span className="text-electric-blue font-medium">クローン技術</span>で遺伝子が世代を超えて継承され、現代のNinnyがGigapolisに<span className="text-gold-accent font-medium">再帰還</span>してミナと出会い、第二世代に加入した。</p>
                    </div>
                  </div>
                </div>
              </div>
