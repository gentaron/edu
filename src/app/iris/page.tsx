      ...
      <div className="relative z-10">
        <PageHeader
          ...
          subtitle={
            <>
              Iris —{" "}
              <Link href="/wiki#ヴァーミリオン" className="text-rose-400 hover:underline">ヴァーミリオン</Link>
              {" "}の英雄、{" "}
              <Link href="/wiki#トリニティ・アライアンス" className="text-rose-400 hover:underline">トリニティ・アライアンス</Link>
              {" "}指導者
            </>
          }
          wikiHref="/wiki#アイリス"
        ...
        <RevealSection>
          <div className="max-w-6xl mx-auto px-4 pb-20">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-1">
                <div className="glass-card rounded-xl overflow-hidden transition-all duration-300">
                  <div className="relative">
                    <img src="https://raw.githubusercontent.com/gentaron/image/main/Iris.png" alt="アイリス" className="w-full aspect-[3/4] object-cover" />
              ...
              <div className="lg:col-span-2 space-y-4">
                <div className="glass-card rounded-xl p-6">
                  <h3 className="text-sm font-bold text-rose-400 mb-4 uppercase tracking-wider">プロフィール</h3>
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-sm">
                    {(
                      [
                        ["所属", <Link key="wl1" href="/wiki#トリニティ・アライアンス" className="text-electric-blue hover:underline">トリニティ・アライアンス</Link>],
                        ["前所属", <React.Fragment key="wl2"><Link href="/wiki#ヴァーミリオン" className="text-electric-blue hover:underline">ヴァーミリオン</Link>諜報機関長</React.Fragment>],
                        ["外見", "青いボディスーツ・白いショール"],
                        ["特徴", "背中ジッパー・黒いダイス"],
                ...
                {/* Abilities */}
                <div className="glass-card rounded-xl p-6">
                  <h3 className="text-sm font-bold text-blue-400 mb-4 uppercase tracking-wider">能力・装備</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {IRIS_ABILITIES.map((ability) => (
                      <div key={ability.name} className={`p-3 rounded-lg border ${ability.color} transition-all hover:scale-[1.02]`}>
                ...
                {/* Key Relationships */}
                <div className="glass-card rounded-xl p-6">
                  <h3 className="text-sm font-bold text-pink-400 mb-4 uppercase tracking-wider">主要関係者</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {IRIS_RELATIONS.map((rel) => (
                      <div key={rel.name} className={`flex items-start gap-3 px-3 py-2 rounded-lg border ${rel.color} hover:bg-cosmic-dark/50 transition-colors`}>
            ...
            <div className="mt-8 glass-card rounded-xl p-6">
              <h3 className="text-sm font-bold text-rose-400 mb-4 uppercase tracking-wider">アイリス物語年表</h3>
              <div className="space-y-2 ml-2 border-l-2 border-rose-400/30 pl-4">
                {IRIS_TIMELINE.map((t, idx) => (
                  <div key={idx} className="flex flex-wrap gap-2 text-sm items-start">
                    ...
                    <span className={`inline-flex items-center text-[10px] font-bold px-1.5 py-0.5 rounded border shrink-0 ${locColor[t.loc] || "bg-gray-500/20 text-gray-300 border-gray-500/30"}`}>{t.loc}</span>
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="glass-card rounded-xl p-5 border border-cyan-400/20">
                <h4 className="text-sm font-bold text-cyan-400 mb-3 flex items-center gap-2">
                  ...
                  <Link href="/wiki#トリニティ・アライアンス" className="text-cyan-400 hover:underline">トリニティ・アライアンス</Link>
                </h4>
                <p className="text-xs text-cosmic-muted mb-3">アイリスが指導する3勢力連合。E520年結成。</p>
              ...
              <div className="glass-card rounded-xl p-5 border border-blue-400/20">
                <h4 className="text-sm font-bold text-blue-400 mb-3 flex items-center gap-2">
                  ...
                  <Link href="/wiki#V7" className="text-blue-400 hover:underline">V7</Link> (Vital Seven)
                </h4>
                <p className="text-xs text-cosmic-muted mb-3"><Link href="/wiki#フィオナ" className="hover:text-nebula-purple hover:underline">フィオナ</Link>が急先鋒の7カ国連合。E515年設立。</p>
                <div className="flex flex-wrap gap-1.5">
              ...
              <div className="glass-card rounded-xl p-5 border border-red-400/20">
                <h4 className="text-sm font-bold text-red-400 mb-3 flex items-center gap-2">
                  ...
                  <Link href="/wiki#アルファ・ヴェノム" className="text-red-400 hover:underline">アルファ・ヴェノム</Link>
                </h4>
                <p className="text-xs text-cosmic-muted mb-3"><Link href="/wiki#イズミ" className="hover:text-nebula-purple hover:underline">イズミ</Link>率いる暗黒組織。シルバー・ヴェノムの後継。</p>
                <div className="flex flex-wrap gap-1.5">
            ...
            <div className="mt-6 text-center">
              <Link href="/story" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-cyan-500/10 border border-cyan-400/30 text-cyan-400 text-sm font-medium hover:bg-cyan-500/20 transition-all hover:scale-[1.02]">
