      ...
      <div className="relative z-10">
        ...
        <main className="px-4 pb-20">
          <div className="max-w-4xl mx-auto space-y-8">
            {/* 概要 */}
            <RevealSection>
              <div className="glass-card rounded-xl p-6 border border-emerald-400/20">
                <h2 className="text-lg font-bold text-emerald-400 mb-4">概要</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm mb-4">
                  <div className="flex gap-3"><span className="text-emerald-400 font-medium shrink-0 w-20">指導者</span><Link href="/wiki#女王リアナ・ソリス" className="text-cosmic-muted hover:text-emerald-400 hover:underline">女王リアナ・ソリス</Link></div>
                  <div className="flex gap-3"><span className="text-emerald-400 font-medium shrink-0 w-20">専門</span><span className="text-cosmic-muted">医療技術・環境再生技術</span></div>
                  <div className="flex gap-3"><span className="text-emerald-400 font-medium shrink-0 w-20">理念</span><span className="text-cosmic-muted">生命の維持と再生</span></div>
                  <div className="flex gap-3"><span className="text-emerald-400 font-medium shrink-0 w-20">ランキング</span><span className="text-cosmic-muted">宇宙第2位</span></div>
                </div>
                <p className="text-sm text-cosmic-muted leading-relaxed">
                  エレシオンは医療技術と環境再生技術で宇宙をリードする平和主義文明圏。支配ではなく「生命の維持と再生」を根幹理念としており、その技術力と人道主義的アプローチから多くの文明圏からの尊敬を集めている。<Link href="/wiki#女王リアナ・ソリス" className="text-gold-accent hover:underline">リアナ・ソリス女王</Link>の治世の下、宇宙規模での平和外交と技術共有を推進している。
                </p>
              </div>
            </RevealSection>
            ...
            <RevealSection>
              <div className="glass-card rounded-xl p-6">
                ...
                <Link href="/wiki#女王リアナ・ソリス" className="block glass-card rounded-lg p-4 border border-emerald-400/20 hover:border-emerald-400/40 transition-colors">
                  <h3 className="text-sm font-bold text-emerald-400">女王リアナ・ソリス</h3>
                  <p className="text-xs text-cosmic-muted mt-1">エレシオン女王。医療技術と環境再生技術で宇宙をリード。「軍拡はさらなる争いを招く」とティエリアに反対。</p>
                </Link>
              </div>
            </RevealSection>
              ...
              <div className="glass-card rounded-xl p-6">
                ...
                <div className="space-y-2 text-sm">
                  <Link href="/civilizations/granbell" className="block p-3 rounded-lg bg-amber-500/5 border border-amber-500/20 hover:border-amber-500/40 transition-colors">
                    ...
                    <span className="text-cosmic-muted text-xs ml-2">— 経済援助と技術供与の関係</span>
                  </Link>
                  <Link href="/civilizations/tyeria" className="block p-3 rounded-lg bg-rose-500/5 border border-rose-500/20 hover:border-rose-500/40 transition-colors">
                    ...
                    <span className="text-cosmic-muted text-xs ml-2">— 軍拡反対で対立</span>
                  </Link>
                  <Link href="/civilizations/dioclenis" className="block p-3 rounded-lg bg-cyan-500/5 border border-cyan-500/20 hover:border-cyan-500/40 transition-colors">
                    ...
                    <span className="text-cosmic-muted text-xs ml-2">— 宇宙探査提案に協力的</span>
                  </Link>
            ...
            <Link href="/civilizations" className="inline-flex items-center gap-1 text-xs text-cosmic-muted hover:text-emerald-400 transition-colors">
              ← 文明圏一覧に戻る
            </Link>
          </div>
        </main>
