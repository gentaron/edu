          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <RevealSection>
              <div className="edu-card rounded-xl p-6 border border-emerald-400/20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm mb-4">
                  <div className="flex gap-3"><span className="text-emerald-400 font-medium shrink-0 w-20">指導者</span><Link href={`/wiki/${encodeURIComponent("女王リアナ・ソリス")}`} className="text-edu-muted hover:text-emerald-400 hover:underline">女王リアナ・ソリス</Link></div>
                ...
                <p className="text-sm text-edu-muted leading-relaxed">
                  エレシオンは医療技術と環境再生技術で宇宙をリードする平和主義文明圏。支配ではなく「生命の維持と再生」を根幹理念としており、その技術力と人道主義的アプローチから多くの文明圏からの尊敬を集めている。<Link href={`/wiki/${encodeURIComponent("女王リアナ・ソリス")}`} className="text-edu-accent hover:underline">リアナ・ソリス女王</Link>の治世の下、宇宙規模での平和外交と技術共有を推進している。
                </p>
              </div>
            </RevealSection>
            ...
            <RevealSection>
              <div className="edu-card rounded-xl p-6">
                ...
                <p className="text-sm text-edu-muted leading-relaxed">
                  長年にわたり医療・環境分野で技術革新を続け、その成果を宇宙中の文明圏に無償で提供してきた。感謝の代償として、他勢力から武力紛争への不介入を求める平和外交を展開。この「技術による平和」のアプローチは、エレシオンを武力紛争の当事者から遠ざける一方で、宇宙規模の影響力を確立させた。<Link href={`/wiki/${encodeURIComponent("女王リアナ・ソリス")}`} className="text-edu-accent hover:underline">リアナ・ソリス女王</Link>の治世では、さらに積極的な平和外交が展開され、対立する勢力間の緩和に多大な貢献を行っている。
                </p>
              </div>
            </RevealSection>
            ...
            <RevealSection>
              <div className="edu-card rounded-xl p-6">
                ...
                <Link href={`/wiki/${encodeURIComponent("女王リアナ・ソリス")}`} className="block edu-card rounded-lg p-4 border border-emerald-400/20 hover:border-emerald-400/40 transition-colors">
