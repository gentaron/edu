        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="edu-card rounded-xl p-6 border border-rose-400/20">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm mb-4">
                <div className="flex gap-3">
                  <span className="text-rose-400 font-medium shrink-0 w-20">指導者</span>
                  <Link
                    href={`/wiki/${encodeURIComponent("グレイモンド・ハウザー")}`}
                    className="text-edu-muted hover:text-rose-400 hover:underline"
                  >
                    総帥グレイモンド・ハウザー
                  </Link>
                </div>
                <div className="flex gap-3">
                  <span className="text-rose-400 font-medium shrink-0 w-20">専門</span>
                  <span className="text-edu-muted">軍事力・防衛ネットワーク</span>
                </div>
                <div className="flex gap-3">
                  <span className="text-rose-400 font-medium shrink-0 w-20">経済基盤</span>
                  <span className="text-edu-muted">軍事技術輸出</span>
                </div>
                <div className="flex gap-3">
                  <span className="text-rose-400 font-medium shrink-0 w-20">信条</span>
                  <span className="text-edu-muted">「軍事力なくして平和は守れない」</span>
                </div>
                <div className="flex gap-3">
                  <span className="text-rose-400 font-medium shrink-0 w-20">ランキング</span>
                  <span className="text-edu-muted">宇宙第3位</span>
                </div>
              </div>
              <p className="text-sm text-edu-muted leading-relaxed">
                ティエリアは宇宙最強の軍事力を誇る文明圏。軍事技術の輸出を経済基盤とし、その防衛ネットワークは宇宙随一と言われる。
                <Link
                  href={`/wiki/${encodeURIComponent("グレイモンド・ハウザー")}`}
                ...
                の下、「軍事力なくして平和は守れない」という信条に基づき、強大な軍備を維持している。
              </p>
            </div>
          </RevealSection>
          ...
          <RevealSection>
            <div className="edu-card rounded-xl p-6">
              ...
              <p className="text-sm text-edu-muted leading-relaxed">
                古くから軍事技術の研究に注力し、他文明圏に対する軍事技術輸出で独自の経済基盤を確立してきた。
                <Link href="/civilizations/granbell" className="text-amber-400 hover:underline">
                  グランベル
                </Link>
                の経済的支配が進む中、ティエリアは軍事力で均衡を保つ政策をとってきた。この経済大国vs軍事大国の構造は、
                <Link
          ...
          <RevealSection>
            <div className="edu-card rounded-xl p-6">
              ...
              <p className="text-sm text-edu-muted leading-relaxed">
                ...
                でもこの対立が表面化した。ファルージャの調停試みに対しては懐疑的な態度をとっている。
              </p>
            </div>
          </RevealSection>
          ...
          <RevealSection>
            <div className="edu-card rounded-xl p-6">
              ...
              <Link
                href={`/wiki/${encodeURIComponent("グレイモンド・ハウザー")}`}
                className="block edu-card rounded-lg p-4 border border-rose-400/20 hover:border-rose-400/40 transition-colors"
              >
                <h3 className="text-sm font-bold text-rose-400">総帥グレイモンド・ハウザー</h3>
                <p className="text-xs text-edu-muted mt-1">
                  ティエリア総帥。宇宙最強の軍事力を指揮。「軍事力なくして平和は守れない」と主張。
                </p>
              </Link>
            </div>
          </RevealSection>
          ...
          <Link
            href="/civilizations"
            className="inline-flex items-center gap-1 text-xs text-edu-muted hover:text-rose-400 transition-colors"
          >
            ← 文明圏一覧に戻る
          </Link>
        </div>
