        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="edu-card rounded-xl p-6 border border-cyan-400/20">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm mb-4">
                <div className="flex gap-3">
                  <span className="text-cyan-400 font-medium shrink-0 w-20">指導者</span>
                  <Link
                    href={`/wiki/${encodeURIComponent("ネイサン・コリンド")}`}
                    className="text-edu-muted hover:text-cyan-400 hover:underline"
                  >
                    科学宰相ネイサン・コリンド
                  </Link>
                </div>
                <div className="flex gap-3">
                  <span className="text-cyan-400 font-medium shrink-0 w-20">専門</span>
                  <span className="text-edu-muted">宇宙探査・科学技術研究</span>
                </div>
                <div className="flex gap-3">
                  <span className="text-cyan-400 font-medium shrink-0 w-20">提唱</span>
                  <span className="text-edu-muted">宇宙共同探査プロジェクト</span>
                </div>
                <div className="flex gap-3">
                  <span className="text-cyan-400 font-medium shrink-0 w-20">ランキング</span>
                  <span className="text-edu-muted">宇宙第5位</span>
                </div>
              </div>
              <p className="text-sm text-edu-muted leading-relaxed">
                ディオクレニスは宇宙探査と科学技術研究の最前線に立つ文明圏。
                <Link
                  href={`/wiki/${encodeURIComponent("ネイサン・コリンド")}`}
          ...
          <RevealSection>
            <div className="edu-card rounded-xl p-6">
              ...
              <p className="text-sm text-edu-muted leading-relaxed">
                科学技術の研究開発に特化し、宇宙探査の分野で多大な成果を挙げてきた。ネイサン・コリンドの下、
                <Link
          ...
          <RevealSection>
            <div className="edu-card rounded-xl p-6">
              ...
              <Link
                href={`/wiki/${encodeURIComponent("ネイサン・コリンド")}`}
                className="block edu-card rounded-lg p-4 border border-cyan-400/20 hover:border-cyan-400/40 transition-colors"
              >
          ...
          <Link
            href="/civilizations"
            className="inline-flex items-center gap-1 text-xs text-edu-muted hover:text-cyan-400 transition-colors"
          >
            ← 文明圏一覧に戻る
          </Link>
        </div>
