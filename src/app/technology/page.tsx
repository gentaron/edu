    ...
    <div className="relative min-h-screen bg-cosmic-dark">
      ...
      <div className="relative z-10">
        <PageHeader
          ...
          title={<Link href="/wiki" className="text-cosmic-gradient hover:underline">技術体系 — Physics-Consistent Technology</Link>}
        ...
        <RevealSection>
          <div className="max-w-6xl mx-auto px-4 pb-20">
            <div className="space-y-4">
              {TECH_DATA.map((tech) => (
                <div key={tech.id} className={`glass-card glass-card-hover rounded-xl border ${tech.borderColor} overflow-hidden transition-all duration-300`}>
