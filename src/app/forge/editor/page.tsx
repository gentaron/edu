      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-3 flex gap-3">
              <button
                ...
                disabled={
                  verificationStatus === "parsing" ||
                  verificationStatus === "typechecking" ||
        ...
        <div className="mt-8 rounded-lg border border-zinc-800 bg-zinc-900/50 p-4">
          <p className="text-xs text-zinc-500">
            <strong className="text-zinc-400">Load-bearing verification:</strong> This editor runs
            the exact same verified typechecker used for all canonical cards (Phase γ Apolon
            compiler). There is no separate UGC safety layer — the Lean 4 theorems apply uniformly.
            Cards that pass verification here can be used in ranked battles without restriction
            (Phase ζ UGC competitive layer).
          </p>
        </div>
      </div>
    </main>
