...
export const ALL_CARDS: GameCard[] = [
  ...
  },
  {
    ...
    name: "ラファエル・ドレイク",
    imageUrl: "/logo.svg",
    flavorText: "「ZAMLT幹部。テスラ重工業連合CEO。コードネーム: トロン。」",
    rarity: "R",
    affiliation: "ZAMLT",
    attack: 5,
    defense: 3,
  ...
  },
  {
    ...
    name: "カルロス・ヴァンダム",
    imageUrl: "/logo.svg",
    flavorText: "「ZAMLT幹部。量子ファイナンス・コントロールCEO。コードネーム: マモン。」",
    rarity: "R",
    affiliation: "ZAMLT",
    attack: 4,
    defense: 4,
  ...
  },
  {
    ...
    name: "アーサー・グリム",
    imageUrl: "/logo.svg",
    flavorText: "「ZAMLT幹部。グローバル・メディア・コングロマリットCEO。コードネーム: ゼブラ。」",
    rarity: "R",
    affiliation: "ZAMLT",
    attack: 3,
    defense: 5,
  ...
  },
  {
    ...
    name: "エリザベス・リンドバーグ",
    imageUrl: "/logo.svg",
    flavorText: "「ZAMLT幹部。A-Registry運営委員会CEO。コードネーム: ルレンツ。」",
    rarity: "R",
    affiliation: "ZAMLT",
    attack: 4,
    defense: 4,
  ...
  },
  {
    ...
    name: "アイリス・ノヴァ",
    imageUrl: "/logo.svg",
    flavorText: "「ZAMLT幹部。インフラストラクチャー・アライアンスCEO。コードネーム: アロエオイル。」",
    rarity: "R",
    affiliation: "ZAMLT",
    attack: 4,
    defense: 3,
