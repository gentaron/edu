...
const CHARACTERS: WikiEntry[] = [
  ...
  },
  {
    ...
    subCategory: "Gigapolis",
    description:
      "E318年に覚醒した戦士決定戦の元チャンピオン。シャドウ・リベリオンのリーダーとしてZAMLTに対する反乱を指揮し、テクロサスの戦士たちとも連携して量子ファイナンス・コアへの伝説的なハッキングによってギガポリス解放戦でメガタワーを占拠。その過程で伴共役の覚醒という奇跡的な現象を起こし、プロトコルXを巡る攻防の決定的な局面を形成した。その勇姿はのちのセリア・ドミニクスを含む多くの者に影響を与え、EDU史上最も象徴的な革命家として神格化されている。",
    era: "E318〜",
  ...
  /* ZAMLT / 企業国家 */
  {
    ...
    subCategory: "Gigapolis",
    description:
      "ZAMLTの創設者にして最高指導者。20万以上の企業国家が乱立するGigapolis経済圏を5超巨大企業に統合し、E301年にZAMLTを設立した冷徹な戦略家。ZAMLTは構成企業の英語名の頭文字をとった名称であり、ゼブラ・コーポレーション（Z）、アロエオイル・コーポレーション（A）、マモン・コーポレーション（M）、ルレンツ・コーポレーション（L）、トロン・コーポレーション（T）の五大企業を傘下に収め、E16連星系の金融取引の95%を掌握した。彼の経済覇権は企業国家体制の最終形態であり、エル・フォルハウスのマーストリヒト革命（E150年）が開いた自由経済の道を、極めて少数のエリートによる中央集権的支配へと逆転させた。ZAMLT本社の最深部に建造された次元の塔（Dimensional Tower）とカタリスト・コアの構想も彼によるものとされる。E318年のアルファ・ケインによるギガポリス解放戦でZAMLTは崩壊し、シュトラスは権力の座から転落した。彼の遺産はnトークン経済システムやA-Registryの階級制度として現在もE16文明圏に根を下ろしており、その影響は銀河系コンソーシアムの経済框架にも波及している。",
    era: "E301〜E318",
    affiliation: "ZAMLT",
    tier: "歴史的人物",
  },
  ...
  },
  {
    ...
    subCategory: "Iris/クレセント",
    description:
      "SUDOMの初代医療総裁。E480年代に医療研究特別植民地だったSUDOMを国家へと昇格させ、遺伝子医療と再生医療の分野でE16文明圏の最先端を走る医療国家の基盤を築いた。スライム危機後の搾取生物対策医療において中心的役割を果たし、V7加盟後は同盟の医療支援と疫学調査を統括した。",
    era: "E480〜",
    affiliation: "SUDOM",
    tier: "Tier 2",
  },
...
const TERMINOLOGY: WikiEntry[] = [
  ...
  },
  {
    ...
    subCategory: "組織・制度",
    description:
      "E301年からE318年まで活動した5超巨大企業の統合体で、E16連星系の経済を事実上支配したメタ企業体である。ZAMLTは構成する5大企業の英語名の頭文字をとった名称である――Z（ゼブラ・コーポレーション）、A（アロエオイル・コーポレーション）、M（マモン・コーポレーション）、L（ルレンツ・コーポレーション）、T（トロン・コーポレーション）。創設者エリオット・シュトラスがGigapolisにおける20万以上の企業国家の覇権争いに勝利し、5社に経済権を集約して設立した。各企業の量子ファイナンス・コアを接続することで、E16連星系全域の金融取引をリアルタイムで制御する画期的な経済システムを構築した。しかし経済効率の極端な追求は社会の二極化を招き、A-Registryの階級格差を固定化する結果となった。ZAMLTはそれまでの企業国家体制（コーポラタムパブリカ）が構築してきた自由経済の秩序を、極めて少数の巨大企業による中央集権的支配に置き換えた。この転換はエル・フォルハウスのマーストリヒト革命（E150年）からアルファ・ケインのギガポリス解放戦（E318年）に至る長い抵抗運動の直接の標的となった。ZAMLT支配下の低階層市民は深刻な貧困と権利制限に苦しみ、シャドウ・リベリオンなどの反乱組織が地下で形成される原因となった。E318年のトロン社壊滅後は4社体制へ移行し、最終的にアルファ・ケインによるギガポリス解放戦で完全崩壊した。ZAMLTの経済的遺産はその後もnトークンシステムやUECOの経済框架に長く影響を残した。崩壊後、その組織の残党の一部はシルバー・ヴェノムの母体となったという説があり、地下組織の歴史的経緯を研究する上で重要な鍵となっている。歴代指導者は初代エリオット・シュトラス（E301〜E318、創設者・最高指導者）。5大企業の各CEO（ラファエル・ドレイク/トロン、カルロス・ヴァンダム/マモン、アーサー・グリム/ゼブラ、エリザベス・リンドバーグ/ルレンツ、アイリス・ノヴァ/アロエオイル）が幹部を構成した。",
     ...
     ═══════════════════════════════════════════ */
  {
    ...
    subCategory: "宇宙文明",
    description:
      "宇宙ランキング第1位の経済大国。GDP150兆ドルで宇宙全体の約25%を占める。首都はオルダシティ。アポロン・Dominion大戦を傍観し、戦後混乱期に一気に浮上。マルチバース開拓と次元間技術で他文明を圧倒。ティエリアとはトゥキディデスの罠の危険性が指摘される一方、エレシオンとは技術分野で連携。現大統領アルゼン・カーリーンは第一回宇宙連合会合を主催した。初代リーダーはマスター・クインシアスであり、セリア時代を高く評価し後継的な文明として位置づけた。歴代指導者はセリアの遺産を継承する理念を維持し、グランベルの経済的繁栄の精神的基盤を形成してきた。",
    era: "現在",
    sourceLinks: [
      {
        url: "https://raw.githubusercontent.com/gentaron/edutext/main/eduuni.txt",
  ...
  },
  {
    ...
    subCategory: "宇宙文明",
    description:
      "宇宙ランキング第3位。軍事技術において宇宙最高峰。圧倒的な艦隊と卓越した戦術力で知られ、宇宙規模の防衛ネットワークを構築。総帥グレイモンド・ハウザーが「軍事力なくして平和は守れない」と主張。近年は軍事技術の輸出を経済基盤として活用。グランベルとの間にトゥキディデスの罠の危険性が指摘されている。歴代総帥の系譜は軍事技術の蓄積とともに受け継がれ、グレイモンド・ハウザーは現実主義的路線を確立した。グランベルとの対話も継続し、トゥキディデスの罠回避に向けた外交努力を行っている。",
    era: "現在",
    sourceLinks: [
      {
        url: "https://raw.githubusercontent.com/gentaron/edutext/main/eduuni.txt",
  ...
  },
  {
    ...
    subCategory: "宇宙文明",
    description:
      "宇宙ランキング第5位。宇宙探査と科学技術研究の最前線。未知の次元や新しい惑星系の開拓を続け、研究成果は他勢力の重要インフラ。科学宰相ネイサン・コリンドがトゥキディデスの罠を科学的に指摘し、対立のエネルギーを共同宇宙探査へ転換する提案を行った。歴代宰相は宇宙探査を国家の使命とし、トゥキディデスの罠回避のため対立のエネルギーを共同宇宙探査へ転換する提案を継続的に実施している。",
    era: "現在",
    sourceLinks: [
      {
        url: "https://raw.githubusercontent.com/gentaron/edutext/main/eduuni.txt",
