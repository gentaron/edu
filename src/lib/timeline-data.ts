...
export const TIMELINE_DATA: {
...
}[] = [
  {
    ...
    events: [
      ...
      e("【宇宙文明圏の起源】M104銀河全域に8つの主要文明圏が存在。アポロン文明圏とドミニオン（セリア・ドミニクス率いるSelinopolis）が最強の二大巨頭として覇権を競い、第三位にグランベルが控える構造。ヴァルカン帝国はアポロン文明圏の衛星国家として存在", "M104銀河"),
  ...
  },
  {
    ...
    events: [
      ...
      e("【ヴァルカン帝国】シトラセレス皇帝が28歳で即位。人口400万の帝国を統べる。厳格な掟の下、妻エレジアとの関係が帝国の象徴となる。ヴァルカン帝国はアポロン文明圏の友好国としてM104銀河の辺境に位置", "ヴァルカン帝国"),
      ...
      e("【グランベルの台頭】マルチバース開拓技術を駆使し、アポロン・ドミニオン大戦を傍観。次元間エネルギー源の独占により経済力を急拡大させ、宇宙第二位から首位への足場を固める", "グランベル"),
      e("【ティエリアの軍事拡大】宇宙最強の軍事力と防衛ネットワークを基盤に独立勢力として台頭。軍事技術輸出を経済基盤として活用し始める", "ティエリア"),
    ],
  },
  {
    ...
    events: [
      ...
      e("【5大文明圏の胎動】アポロン・ドミニオン大戦の激化により、M104銀河の多極化が加速。エレシオンが医療技術で台頭、ファルージャが文化的影響力を拡大、ディオクレニスが宇宙探査に着手。グランベルは依然経済2位", "M104銀河"),
      ...
      e("【シトラセレス皇帝の失踪】ヴァルカン帝国の皇帝が忽然として姿を消す。帝国の掟を破る謎の女集団の関与が噂される。ヴァルカン帝国は後継者問題で混乱に陥り、のちに周辺文明圏に吸収され歴史から姿を消す", "ヴァルカン帝国"),
  ...
  },
  {
    ...
    events: [
      ...
      e("E335〜E370: セリア・ドミニクスがZAMLTを倒しSelinopolis改名。セリア黄金期 — フェルミ音楽・nトークン経済・AURALISすべての頂点に到達", "Gigapolis"),
      e("E340: Slime Woman出現（ペルセポネ仮想宇宙実験の事故で高次元世界から顕現）。特定の個人（Jun）との間に特異な相互作用が発生。Tier 1アクティブ現役最強格として約200年にわたり存在し続ける", "Gigapolis"),
      e("【ジュンの遭遇】33歳の無職男性ジュンが自宅でスライム状の高次元生命体と遭遇。Slime Womanがジュンの部屋に侵入し美しい女性の姿に変身。この接触はペルセポネ実験の次元断絶を通じた高次元存在の顕現と解析される。EDU宇宙論において「人間と高次元存在の共存可能性」を示す重要な事例", "Gigapolis"),
      e("E350: 第五次繁栄フェスティバル開催 — 戦士決定戦とホロアート融合。ネオンコロシアム視聴率95%。シャドウ・リベリオンの反体制ホログラムがアンダーグリッドで話題に", "Gigapolis"),
      e("【ディオクレニスの宇宙探査】次元技術を応用した宇宙共同探査プロジェクトを立ち上げ。異文明圏との接触を開始し、M104銀河の多様な文明の実態を体系的に記録し始める", "ディオクレニス"),
      e("E365頃: セリアがエヴァトロンと同盟締結、GDP81京ドル達成、都市名をDominionへ改称", "Gigapolis"),
      e("E370: アポロン・ドミニオン大戦宣戦布告 — アポロン文明圏（ロナン・アーサ）とドミニオン（セリア・ドミニクス）の全面戦争。セリアへの同盟提案拒絶が端緒", "M104銀河"),
      ...
      e("【アポロン・ドミニオン大戦と5大文明圏】アポロン文明圏とドミニオンの激突はM104銀河全体に波及。グランベルは大戦を意図的に傍観し経済的台頭の足場に。ティエリアは防衛技術輸出で軍事力を拡大。エレシオンは戦傷者治療で名声を確立。ファルージャは外交調停で存在感を示す。大戦後の権力真空が5大文明圏の台頭を決定づける", "M104銀河"),
      ...
      e("【グランベル首位確定】アポロン・ドミニオン大戦後の混乱期に一気に浮上。GDP150兆ドルを達成し宇宙最大の経済圏に。マスター・クインシアスが「次元を超える力が、この手に」と宣言", "グランベル"),
      e("【ティエリア第3位に】軍事技術輸出で経済基盤を拡大。グレイモンド・ハウザー総帥が「軍事力なくして平和は守れない」と主張。エレシオンのリアナ女王と対立", "ティエリア"),
  ...
  },
  {
    ...
    events: [
      ...
      e("【エヴァトロン第14位に転落】かつてのドミニオン支配力から大幅後退。セリアンズの地下活動が継続。グランベルの支援を受けた兵器でセリアンズを鎮圧した経緯もあり、グランベルの影響下に", "M104銀河"),
      e("【カステリア・グレンヴェルトの顕現】グランベル出身の次元跳躍能力者。マルチバース技術により異次元（地球AD2026年の日本・美咲が丘高校）に転移。金髪蒼眼、浮遊能力、睡眠操作能力を持つ。セバストレスと呼ばれる人物と関係あり。グランベルの次元間偵察計画の一環とも、独自の次元跳躍事故ともされる", "グランベル"),
  ...
  },
  {
    ...
    events: [
      ...
      e("【第一回宇宙連合会合】グランベルの首都オルダシティで開催。アルゼン・カーリーン大統領「争いを超え、共存と繁栄の道を見つけることが次世代への責任」。ネイサン・コリンドがトゥキディデスの罠を提起。ティエリア・エレシオン間の対立が表面化", "M104銀河"),
      ...
      e("【ミューのダンジョン探検】Dioclenis文明圏の探査プログラムに参加したレベル607（上限1000）の英雄ミューが、異常空間「エロティック・トラップ・ダンジョン」の探検記録を残す。サキュバスやLust Leech等の高次元生命体との遭遇を記録し、ディオクレニスの宇宙生物学に多大な貢献", "ディオクレニス"),
      e("【5大文明圏とE16の統合】グランベル主導の宇宙経済協力機構（UECO）にE16代表も参加。ギガポリスのnトークン経済とグランベルの量子経済が連携。エレシオンの医療技術がE16に導入され、平均寿命がさらに延長。ティエリアの防衛ネットワークがE16星系の防衛にも貢献", "M104銀河"),
