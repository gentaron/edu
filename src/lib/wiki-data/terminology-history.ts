...
export const WIKI_HISTORY: WikiEntry[] = [
...

  {
    ...
    subCategory: "歴史・時代",
    description:
      "E95年からE110年にかけて実施されたE16連星系内の最初の本格的な星間航海計画。バーズ帝国時代に構想された惑星間航行技術が、帝国分裂後も各地の技術者集団によって継承・発展され、Eros-7への最初の有人飛行がE97年に成功した。Eros-7からの搾取生物の発見は、入植者たちに新たな資源と危険の双方をもたらした。第一次星間航海の成果はのちの惑星ビブリオ建設（E120年頃）に継承され、E16連星系全域に居住圏を拡大する技術的基盤となった。この時期に確立された星間航行の航路標識と通信プロトコルは、現在でもE16連星系内の航行インフラの基礎として機能している。",
  },
  ...
  /* 企業国家台頭 (E90〜E205) */
  {
    ...
    subCategory: "歴史・時代",
    description:
      "E120年に西大陸の主要企業群が連合して設立した株式会社共和国。企業国家体制の最も成功した例として、14兆ドルのGDPを誇る経済連合体を構築した。コーポラタムパブリカは利潤追求だけでなく、インフラ整備、教育、医療、宇宙探査などの公共サービスも担い、国家の役割を代替する画期的な統治モデルを確立した。この体制はE205年のパクス・ロンバルディカ期に最盛期を迎え、約70年にわたる長期安定をもたらした。コーポラタムパブリカの設立はE16文明圏において「企業が国家となる」という独特の政治形態の起点となり、のちに20万以上の企業国家がGigapolis全域で競合する時代を招くことになる。",
  },

  {
    ...
    subCategory: "歴史・時代",
    description:
      "E80年頃から始まった次元極地平技術の発見を端緒とする宗教・哲学運動の台頭期。テミルタロンがこの運動の思想的指導者となり、次元極地平を「宇宙の意志」の顕現として神聖視する教義を構築した。テミルタロンはテンプル・オブ・ホライゾンを建設し、サイケデリック・コスモロジーを提唱して次元ピラミッドの構想の原型を提供した。テクノ宗教運動は技術啓蒙時代の合理主義に対する精神的なアンチテーゼとして広範な支持を集め、Troyaneを聖地とする信仰共同体を形成した。この運動の思想的遺産はAURALISの創設理念にも影響を与え、E16文明圏の精神文化に深い根を下ろしている。",
  },

  {
    ...
    subCategory: "歴史・時代",
    description:
      "E140年頃に西大陸の企業国家連合によって開始されたパラトン周辺の大規模都市統合計画。技術啓蒙時代の人口爆発に対応するため、パラトンを核とした複数都市の統合が計画され、E150年のマーストリヒト革命までにメガロポリス化が進行した。都市計画はセントラル・タワーを中心とする放射状の区画構造を採用し、後にテスラ地区、大広場、テック・コリドーなどの多様な機能地区が形成された。ギガポリスの都市計画はシンフォニー・オブ・スターズの表面重力（0.92G）と自転周期（44時間4分）に最適化された独自の建築様式を生み出し、のちにE16連星系の政治・経済・文化の中心地となる基盤を築いた。",
  },
  ...
  /* パクス〜繁栄 (E150〜E288) */
  {
    ...
    subCategory: "歴史・時代",
    description:
      "E205年に主要企業群が協調統治体制への移行を宣言し、E205年からE278年まで続いた「ロンバルディアの平和」時代の幕開け。ロンバルディア帝国が企業国家間の協調体制の枠組みを提供し、約70年にわたる長期安定を実現した。この時期には惑星ビブリオのロレンツィオ国際大学が設立され、次元極地平理論の基礎研究が本格化した。しかし企業間の寡占化が進み、市民の政治参加権が制限される傾向が強まったことが、最終的にZAMLTによる強硬な経済覇権への移行を招く要因となった。パクス・ロンバルディカの繁栄はE16文明圏において「企業統治の黄金時代」として記憶され、その制度的遺産は現在のUECOの枠組みにも影響を与えている。",
  },
...

  {
    ...
    subCategory: "歴史・時代",
    description:
      "E260年からE280年にかけて活動した初代Wonder Woman、ダイアナの歴史的台頭期。AURALIS Protoの文化的恩恵をシンフォニー・オブ・スターズ全土にもたらした伝説的人物であり、その圧倒的な存在感と人々を鼓舞する力でEDU史上最も愛される英雄の一人として語り継がれる。ダイアナの台頭はパクス・ロンバルディカ期から企業国家間抗争期への移行期において、文化と人道の価値を再確認する象徴的な出来事であった。彼女の影響力はのちのAURALIS Collective創設者たちに深い影響を与え、AURALISの創設理念の源流の一つとなった。ダイアナの没後も彼女の精神は「Wonder Woman」としての象徴的役割を通じて継承され、E16文明圏における英雄的理想の原型として機能し続けている。",
  },
...

  {
    ...
    subCategory: "歴史・時代",
    description:
      "E301年にZAMLT（5つの超巨大企業の連合体）がGigapolisに本社を置き、E16連星系の経済覇権を掌握した歴史的転換点。コーポラタムパブリカの末期に台頭した5企業が合流してZAMLTを設立し、20万以上の企業国家間の覇権争いを5企業への集約によって終結させた。ZAMLTは量子ファイナンス・コアと呼ばれる独自の金融システムを構築し、E16連星系の経済活動の大部分を統制した。次元極地平技術の軍事転用と兵器生産も進め、シルバープラントや次元の塔などの巨大施設を建造した。ZAMLTの覇権は市民の政治参加権を制限し、A-Registryの階級制度を社会固定化装置として悪用する側面も持ち、のちのアルファ・ケインによるギガポリス解放戦（E318年）の直接的な要因となった。",
  },

  {
    ...
    subCategory: "戦争・事件",
    description:
      "E316年からE318年にかけて、テスラ地区で育ったアルファ・ケインが戦士決定戦で優勝し、伴共役の覚醒という奇跡的な現象を起こした一連の歴史的事件。アルファ・ケインは戦士決定戦でその圧倒的な戦闘力を証明し、ZAMLT支配下の低階層市民に希望の象徴となった。E318年にはシャドウ・リベリオンを組織し、テクロサスの戦士たちと連携してギガポリス解放戦を決起した。伴共役の覚醒はZAMLTの次元エネルギー技術の原理を覆す未知の現象であり、この覚醒を持ってケインはZAMLTの量子ファイナンス・コアへの伝説的なハッキング攻撃を実行し、Gigapolisのメガタワーを武力占拠した。ケインの覚醒と解放戦はE16文明圏における「企業国家の終焉」の象徴として歴史に刻まれている。",
  },
...

  {
    ...
    subCategory: "歴史・時代",
    description:
      "E380年からE400年まで約20年間続いたスライム危機の収束過程。変異した搾取生物による大規模災害はEros-7からシンフォニー・オブ・スターズ全域に波及し、壊滅的な被害をもたらしたが、Eros-7のマトリカル社会が独自に開発した生物学的封じ込め技術が決定的な役割を果たした。シンフォニー・オブ・スターズでは、アヤカ・リンがアンダーグリッドでの制圧作戦を先陣を切って指揮し、レイラ・ヴィレル・ノヴァもオアシス・ハウスを拠点にスライム討伐で英雄的活躍を見せた。収束後、搾取生物対策医療はSUDOMの主要産業として発展し、この技術は医療や環境修復分野で広く応用されることになった。スライム危機の教訓はテクノ文化ルネサンス期の「技術の民主化」と「生態系との調和」という理念に強く反映され、環境保護法の整備を促す決定的な要因となった。",
  },

  {
    ...
    subCategory: "歴史・時代",
    description:
      "E475年にエヴァトロン崩壊後の民主化と自由化を背景に始まった文化・技術の飛躍期。次元極地平技術が軍事・企業エリートから一般市民に開放され、空間ホールを通じた惑星間移動が日常化した。これによりE16連星系内の各地域間交流が爆発的に増加し、異なる植民地の文化が融合する新しい芸術・音楽・哲学が花開いた。テクノ文化ルネサンスはAURALIS第二世代の設立（E522年）を準備する文化的土壌となり、フェルミ音楽の現代的再解釈やOffenbach種との協創芸術などが生まれた。また、ペルセポネ計画の初期構想もこの時期に生み出され、次元ピラミッド理論の基礎研究が惑星ビブリオで開始された。このルネサンスはE16文明圏に「技術と文化の融合」という新たなパラダイムをもたらした。",
  },
...

  {
    ...
    subCategory: "歴史・時代",
    description:
      "E520年に設立された銀河系規模の協力機構で、E16文明圏と他宇宙文明圏との対話と協力を目的としている。銀河系コンソーシアムはグランベル（経済1位）、エレシオン（医療2位）、ティエリア（軍事3位）、ファルージャ（文化4位）、ディオクレニス（探査5位）の五大文明圏を核に構成され、トゥキディデスの罠の回避と宇宙規模の秩序構築を掲げている。コンソーシアムの設立はE16文明圏が銀河規模の国際舞台に進出する画期的な出来事であり、E528年の第一回宇宙連合会合の開催へと繋がった。コンソーシアムの下で標準宇宙暦の制定や宇宙文明圏間の通商ルートの整備が進められており、E16文明圏の外交・経済・安全保障に新たな枠組みを提供している。",
  },
