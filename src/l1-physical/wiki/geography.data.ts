...
export const WIKI_GEOGRAPHY = [
...

  {
    ...
    subCategory: "自然地形",
    description:
      "ブルーローズ国家の大部分を覆う広大な平原地帯で、クレセント大地方最大の農業生産地である。ブルーローズ平原の土壌はシンフォニー・オブ・スターズ特有の青い鉱物を含み、雨季には一面に青い花が咲き乱れることから「ブルーローズ（青い薔薇）」の名が付けられた。平原には高度な農業自動化システムが導入され、クレセント地方の食料需要の約40%をこの平原で賄っている。平原の北端にはフィオナがV7設立（E515年）を宣言した「自由の丘」があり、ブルーローズの国家独立の象徴として史跡に指定されている。テクノ文化ルネサンス期には平原に次元極地平技術の実証実験場が建設され、空間ホールの安定化制御の試験が行われた。平原の西側はヴェルミリオン渓谷に接し、両国の国境には緩衝地帯が設定されている。",
  },

  {
    ...
    subCategory: "自然地形",
    description:
      "クロセヴィア国家の南部に広がる熱帯密林で、クレセント大地方最大の原生林である。クロセヴィア密林は特有の複雑な気象システムを内包し、局地的な暴風雨を頻繁に発生させることから気象制御技術の研究フィールドとして利用されてきた。密林にはシンフォニー・オブ・スターズ固有の動植物が多数生息し、中には医薬品の原料となる希少植物も含まれている。SUDOMの医療研究者が密林の植物探索を定期的に実施し、新薬の開発に貢献している。密林の深部には未踏査の区域が広がり、スライム危機時には変異した搾取生物の隠れ家となった可能性が指摘されている。カスチーナ・テンペストは密林の気象観測データを基に気象制御技術を開発し、クロセヴィアの国家的特色を形成した。",
  },
...

  {
    ...
    subCategory: "宇宙構造物",
    description:
      "シンフォニー・オブ・スターズとE16連星系内の各惑星・コロニーを結ぶ惑星間宇宙港で、西大陸のPersepolisと惑星ビブリオのポート・ロレンツィオを主要ハブとして運営されている。宇宙港スペースポートは年間数万隻の宇宙船を処理し、旅客・貨物の双方を扱うE16連星系最大の交通インフラである。スペースポートの税関エリアではA-Registryの確認と入国審査が行われ、セキュリティはUECOの合同部隊が担当している。テクノ文化ルネサンス期には空間ホール接続ターミナルが併設され、従来の宇宙船航行と次元ホール移動の両方が利用可能となった。宇宙港周辺にはホテル、レストラン、通商施設が立ち並び、事実上の国際都市として機能している。アルファ・ヴェノムのテロ活動警戒区域にも指定されており、厳重なセキュリティプロトコルが適用されている。",
  },
