...
export const WIKI_TERMS = [
...

  {
    ...
    subCategory: "社会制度",
    description:
      "E16文明圏で広く使用されるアイテム・能力・人物の希少性評価システム。レア度はCommon（コモン）、Uncommon（アンコモン）、Rare（レア）、Epic（エピック）、Legendary（レジェンダリー）、Mythic（ミシック）の6段階に分類され、各段階はnトークンでの取引価格やA-Registryの特権に直接影響する。戦士決定戦の出場資格やIRISランキングの算定にもレア度が考慮され、社会的評価の重要な指標となっている。レア度の判定基準はUECOが管理する中央評価委員会によって定期的に見直され、新技術の普及や社会構造の変化に応じて調整される。AURALISのメンバーの多くはLegendary以上のレア度を持ち、アルファ・ケインやジェンはMythicに分類されている。",
  },
  ...
  /* IRIS (2) */
  {
    ...
    subCategory: "社会制度",
    description:
      "E16文明圏の戦闘員・能力者の実力を格付けする公式ランキングシステムで、ヒーローエージェンシーによって管理されている。IRISランキングは戦闘力指数を基礎としつつ、実戦での勝敗記録、ミッションの達成度、社会的貢献度などの多角的な評価要素を組み合わせて総合順位を決定する。現在のランキング1位はアイリス、2位はフィオナ、3位はマリーナ・ボビン、4位はセバスチャン・ヴァレリウス、5位はカスチーナ・テンペストである。ランキング上位者には特別なnトークン報酬とA-Registry上の名誉階位が与えられ、軍事的・外交的な発言力にも直結する。ランキングの改定は四半期ごとに行われ、戦士決定戦の結果が大きな影響を与える。銀河系コンソーシアム設立後は宇宙文明圏全体へのランキング拡張が検討されている。",
  },
...

  {
    ...
    subCategory: "文化",
    description:
      "E16文明圏で発展した多様な食文化。シンフォニー・オブ・スターズの自生植物と地球から持ち込まれた作物の交配により、地球の料理を基盤にしながら独自の進化を遂げた。クレセント大地方ではミエルテンガ湖の淡水魚料理、ブルーローズ平原の穀物料理、ヴェルミリオン渓谷の峡谷野菜が名物である。テクノ文化ルネサンス期には空間ホールを通じた異星食材の流通が始まり、ファルージャの砂漠料理、エレシオンの健康食、グランベルの融合料理などがE16連星系全域で楽しめるようになった。ビブリオのアカデミアでは「食の哲学」という学際的研究分野が設立され、食文化を通じた文明間の理解促進が模索されている。サウス・マーケットの海上市場は異星食材が集まる美食の聖地として知られている。",
  },
  ...
  /* 外交・法規 (5) */
  {
    ...
    subCategory: "法規",
    description:
      "E16連星系内の複数惑星・国家間で締結された条約群の総称。最も重要な条約はE151年の新ヘルシンキ宣言に基づく「惑星連邦構想条約」で、複数の惑星文明が平等な立場で参加する統合体制の枠組みを規定している。その他、「次元兵器制限条約（E288年、メルディア戦争の教訓から）」「搾取生物管理条約（E400年、スライム危機の教訓から）」「A-Registry改革条約（E490年、ネオクラン同盟主導）」が重要な惑星間条約である。銀河系コンソーシアム設立（E520年）後は、E16連星系外の宇宙文明圏との条約締結も進められ、「トゥキディデスの罠回避条約」がグランベルとティエリア間の軍縮を規定している。",
  },

  {
    ...
    subCategory: "法規",
    description:
      "E495年からE500年にかけて設立された宇宙規模の統合的ガバナンス組織で、M104銀河全域の平和と安定維持を目的としている。ネオクラン同盟、UECO、ヒーローエージェンシーの三大勢力を統合して誕生し、グランベル（経済1位）とティエリア（軍事3位）の共同議長体制で運営されている。最大の課題であるトゥキディデスの罠の回避を最重要政策目標とし、対立する勢力間の調停と軍縮を推進している。E524年の諸世界連邦サミットを主催し、宇宙規模の外交協議を実現した。E530年の次元ブリッジ完成後は宇宙文明圏間の交流拡大に伴う新たな法規整備を進めている。エレシオンの平和主義とディオクレニスの科学的アプローチを政策の両輪としている。",
  },

  {
    ...
    subCategory: "経済",
    description:
      "E16文明圏における惑星間・星系間の商業取引ルートの定義と管理規則。主要な通商路はシンフォニー・オブ・スターズを中心に放射状に広がり、惑星ビブリオへの学術ルート、Eros-7へのエネルギールート、ガイア・リングへの資源ルートが四大動脈を形成している。テクノ文化ルネサンス期に空間ホールの民生化が進み、従来の宇宙船航行ルートに加えて次元ホール経由の即時物流が可能となった。通商路の安全はUECOと銀河系コンソーシアムの合同部隊が担当し、海賊行為や密輸への取り締まりを行っている。プロキオ・ネクサスを中心とする宇宙規模の貿易ルートとの接続もE520年以降本格化している。通商路の定義はnトークン経済システムと不可分であり、物流コストの低減がE16文明圏全体の経済発展に直結している。",
  },
...

  {
    ...
    subCategory: "文化",
    description:
      "E16文明圏で愛好される各種スポーツ・競技活動の総称。シンフォニー・オブ・スターズの表面重力（0.92G）と自転周期（44時間4分）という惑星環境に適応して独自に発展した競技が多い。最も人気のあるのはネオンコロシアムで開催される戦士決定戦だが、それ以外にも次元スキー（アイアン・シンジケートの山岳地帯で行われる）、ゼロGバスケット（Gigapolisのテック・コリドー地区発祥）、プラズマランニング（西大陸の広大平原を利用したマラソン競技）などが広く愛好されている。テクノ文化ルネサンス期以降は、次元極地平技術を応用した「次元格闘技」や「空間アクロバティクス」といった新競技も誕生した。各競技の大会はnトークン賞金が設定され、プロ選手として活動する者も増加している。銀河系コンソーシアム主導で宇宙文明圏間スポーツ交流が始まっており、グランベルのマルチバース・ゲームズが最も権威ある国際大会として知られている。",
  },
