...
export const WIKI_ORGANIZATIONS = [
  ...
  /* 追加組織 */
  {
    ...
    subCategory: "組織・制度",
    description:
      "ファランクス皇帝がE15年に設立したバーズ帝国の行政機関。帝国の法律・徴税・公共事業・人口管理を統括し、シンフォニー・オブ・スターズ西大陸全土に広がる支配体制の行政的基盤として機能した。官庁は三つの部門から構成され、法務部が帝国法の制定と執行を、財務部がnトークン以前の旧通貨システムによる徴税を、工事部が都市建設と道路整備を担当した。帝国崩壊後はその機能の大部分が惑星国家連合に引き継がれたが、一部の行政記録はTroyaneの地下公文書館に保管されたままである。官庁の官僚制度は後にZAMLT期の企業国家体制とUECO期の超国家機関の両方に影響を与えた。",
  },
  {
    id: "org-第一移民評議会",
    name: "第一移民評議会",
  ...
  },
  {
    ...
    subCategory: "組織・制度",
    description:
      "クレセント7カ国間の紛争解決と国際法の解釈を担う司法機関。E320年のクレセント7カ国独立に伴い設立され、V7とトリニティ・アライアンスの対立の中で中立な裁定者として機能している。法廷は7カ国の法体系の調和を図りつつ、次元極地平技術の軍事利用や空間ホールの管理に関する国際的な法規制の整備を進めている。法廷の判事は各国民の信任に基づき選出され、任期は5年である。アルファ・ヴェノムの犯罪行為に対する国際的な裁判もこの法廷の管轄であり、クレセント地方の平和維持における最重要機関として位置づけられている。",
  },
  {
    id: "org-次元境界監視機構",
    name: "次元境界監視機構",
  ...
  },
  {
    ...
    subCategory: "その他",
    description:
      "Eros-7における搾取エネルギーの採掘と管理を統括する公社。マトリカル・カウンシルの監督下で運営され、搾取生物の培養・配置・エネルギー回収・配送の全工程を管理している。公社は多数の採掘施設を運営し、その中でもスクイーズ・アビスは最大規模の拠点として知られた。搾取体制の段階的解体に伴い、公社の規模は縮小しているが、現在でもエネルギー生産の一部を担っている。公社の技術スタッフが開発した搾取エネルギー変換技術の一部は、のちにナノメディシンに応用され、搾取技術の平和的転用の成功事例となっている。",
  },
  {
    id: "org-惑星間条約機構",
    name: "惑星間条約機構",
